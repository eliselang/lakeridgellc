...
public class Patient {
  ...
  //  public Patient(String firstName, String lastName, String dateOfBirth, String phoneNum, String socialSec, String address, String city, String state,
 //           String healthInsProv, String healthInsNum ) {
 //   	this(0, firstName, lastName, dateOfBirth, phoneNum, socialSec, address, city, state, healthInsProv, healthInsNum);
//    }
